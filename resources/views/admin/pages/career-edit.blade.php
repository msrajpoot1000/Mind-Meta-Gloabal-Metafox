    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin-career.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
    <label for="job_type" class="form-label">Job Type <span class="text-danger">*</span></label>
    <input type="text" name="job_type" id="job_type" class="form-control @error('job_type') is-invalid @enderror" value="{{ old('job_type', $item->job_type ?? '') }}">
