...
<!-- Mirrored from themesdesign.in/webadmin/layouts/tables-advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:27 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Advance Tables | webadmin - Admin & Dashboard Template</title>
            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="page-title-box align-self-center d-none d-md-block">
                        <h4 class="page-title mb-0">Advance Tables</h4>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <div role="complementary" class="gridjs gridjs-container" style="width: 100%;">
                                            <div class="gridjs-head">
                                                <div class="gridjs-search"><input type="search"
                                                        placeholder="Type a keyword..." aria-label="Type a keyword..."
                                                        class="gridjs-input gridjs-search-input" value=""></div>
                                            </div>
                                            <div class="gridjs-wrapper" style="height: auto;">
                                                <table role="grid" class="gridjs-table" style="height: auto;">
                                                    <thead class="gridjs-thead">
                                                        <tr class="gridjs-tr">
                                                            <th data-column-id="name" class="gridjs-th gridjs-th-sort"
                                                                tabindex="0" style="min-width: 86px; width: 171px;">
                                                                <div class="gridjs-th-content">Name</div><button
                                                            ...
                                                            <th data-column-id="email" class="gridjs-th gridjs-th-sort"
                                                                tabindex="0" style="min-width: 185px; width: 367px;">
                                                                <div class="gridjs-th-content">Email</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            </th>
                                                            <th data-column-id="position"
                                                                ...
                                                                style="min-width: 242px; width: 480px;">
                                                                <div class="gridjs-th-content">Position</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            </th>
                                                            <th data-column-id="company"
                                                                class="gridjs-th gridjs-th-sort" tabindex="0"
                                                                style="min-width: 125px; width: 248px;">
                                                                <div class="gridjs-th-content">Company</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            </th>
                                                            <th data-column-id="country"
                                                                class="gridjs-th gridjs-th-sort" tabindex="0"
                                                                style="min-width: 118px; width: 234px;">
                                                                <div class="gridjs-th-content">Country</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            </th>
                                                    ...
                                                    <tbody class="gridjs-tbody">
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            <td role="alert" colspan="5"
                                                                class="gridjs-td gridjs-message gridjs-error">An error
                                                                happened while fetching the data</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table role="grid" class="gridjs-table" style="height: 400px;">
                                                    <thead class="gridjs-thead">
                                                        <tr class="gridjs-tr">
                                                            <th data-column-id="name"
                                                                class="gridjs-th gridjs-th-sort gridjs-th-fixed"
                                                                tabindex="0"
                                                                style="min-width: 86px; width: 147px; top: 0px;">
                                                                <div class="gridjs-th-content">Name</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            ...
                                                            <th data-column-id="email"
                                                                class="gridjs-th gridjs-th-sort gridjs-th-fixed"
                                                                tabindex="0"
                                                                style="min-width: 185px; width: 315px; top: 0px;">
                                                                <div class="gridjs-th-content">Email</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            ...
                                                            <th data-column-id="position"
                                                                class="gridjs-th gridjs-th-sort gridjs-th-fixed"
                                                                tabindex="0"
                                                                style="min-width: 242px; width: 412px; top: 0px;">
                                                                <div class="gridjs-th-content">Position</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            ...
                                                            <th data-column-id="company"
                                                                class="gridjs-th gridjs-th-sort gridjs-th-fixed"
                                                                tabindex="0"
                                                                style="min-width: 249px; width: 424px; top: 0px;">
                                                                <div class="gridjs-th-content">Company</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                            ...
                                                            <th data-column-id="country"
                                                                class="gridjs-th gridjs-th-sort gridjs-th-fixed"
                                                                tabindex="0"
                                                                style="min-width: 118px; width: 201px; top: 0px;">
                                                                <div class="gridjs-th-content">Country</div><button
                                                                    tabindex="-1" aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                    ...
                                                    <tbody class="gridjs-tbody">
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="email" class="gridjs-td">
                                                                traci@example.com</td>
                                                            <td data-column-id="position" class="gridjs-td">Corporate
                                                                Identity Director</td>
                                                            <td data-column-id="company" class="gridjs-td">Koelpin -
                                                                Goldner</td>
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="email" class="gridjs-td">
                                                                kerry@example.com</td>
                                                            <td data-column-id="position" class="gridjs-td">Lead
                                                                Applications Associate</td>
                                                            <td data-column-id="company" class="gridjs-td">Feeney,
                                                                Langworth and Tremblay</td>
                                                            <td data-column-id="country" class="gridjs-td">Niger</td>
                                                        </tr>
                                                        <tr class="gridjs-tr">
                                                            <td data-column-id="name" class="gridjs-td">Patsy</td>
                                                            <td data-column-id="email" class="gridjs-td">
                                                                patsy@example.com</td>
                                                            <td data-column-id="position" class="gridjs-td">Dynamic
                                                                Assurance Director</td>
                                                            <td data-column-id="company" class="gridjs-td">Streich Group
                                                            </td>
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="email" class="gridjs-td">
                                                                cathy@example.com</td>
                                                            <td data-column-id="position" class="gridjs-td">Customer
                                                                Data Director</td>
                                                            <td data-column-id="company" class="gridjs-td">Ebert,
                                                                Schamberger and Johnston</td>
                                                            <td data-column-id="country" class="gridjs-td">Mexico</td>
                                                        </tr>
                                                        <tr class="gridjs-tr">
                                                            <td data-column-id="name" class="gridjs-td">Tyrone</td>
                                                            <td data-column-id="email" class="gridjs-td">
                                                                tyrone@example.com</td>
                                                            <td data-column-id="position" class="gridjs-td">Senior
                                                                Response Liaison</td>
                                                            <td data-column-id="company" class="gridjs-td">Raynor,
                                                                Rolfson and Daugherty</td>
                                            ...
                                            <div class="gridjs-footer">
                                                <div class="gridjs-pagination">
                                                    <div role="status" aria-live="polite" class="gridjs-summary"
                                                        title="Page 1 of 1">Showing <b>1</b> to <b>10</b> of <b>10</b>
                                                        results</div>
                                                    <div class="gridjs-pages"><button tabindex="0" role="button"
                                                            disabled="" title="Previous" aria-label="Previous"
                                                            class="">Previous</button><button tabindex="0" role="button"
