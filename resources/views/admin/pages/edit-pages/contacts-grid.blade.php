...
<!-- Mirrored from themesdesign.in/webadmin/layouts/contacts-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:10 GMT -->
<head>

        <meta charset="utf-8" />
        <title>User Grid | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">User Grid</h4>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                        <div>
                                            <ul class="nav nav-pills">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="contacts-list.html" data-bs-toggle="tooltip" data-bs-placement="top" title="List"><i class="bx bx-list-ul"></i></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="contacts-grid.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Grid"><i class="bx bx-grid-alt"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex gap-2 pt-4">
                                                <button type="button" class="btn btn-subtle-primary btn-sm w-50"><i class="bx bx-user me-1"></i> Profile</button>
                                ...
                                <div class="col-xl-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md">
                                                    <div class="avatar-title bg-primary-subtle  text-primary display-6 m-0 rounded-circle">
                                ...
                                <div class="col-xl-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img src="assets/images/users/avatar-4.jpg" alt="" class="avatar-md rounded-circle img-thumbnail">
                                                </div>
                                                <div class="flex-1 ms-3">
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/contacts-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:11 GMT -->
</html>