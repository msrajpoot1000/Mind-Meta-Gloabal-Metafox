...
<!-- Mirrored from themesdesign.in/webadmin/layouts/email-read.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:28:54 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Read Email | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">Read Email</h4>
                        </div>
                        <!-- end page title -->
