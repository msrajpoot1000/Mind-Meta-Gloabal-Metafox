...
<!-- Mirrored from themesdesign.in/webadmin/layouts/charts-apex.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:28 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Apex Charts | webadmin - Admin & Dashboard Template</title>
        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="page-title-box align-self-center d-none d-md-block">
                    <h4 class="page-title mb-0">Apex Charts</h4>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="area_chart_spline" data-colors='["#1f58c7", "#28b765"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="column_chart" data-colors='["#ed5555", "#1f58c7", "#28b765"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!--end col-->
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="line_column_chart" data-colors='["#1f58c7", "#28b765"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="basic_candlestick" data-colors='["#ed5555", "#1f58c7"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="combo_candlestick" data-colors='["#ed5555", "#1f58c7"]' class="apex-charts" dir="ltr"></div>
                                <div id="combo_candlestick_chart" data-colors='["#ed5555", "#f4c238"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="basic_box" data-colors='["#1f58c7", "#52c6ea"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="box_plot" data-colors='["#ed5555", "#974be0"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="simple_bubble" data-colors='["#1f58c7", "#974be0","#f4c238", "#28b765"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="bubble_chart" data-colors='["#1f58c7", "#974be0","#f4c238", "#28b765"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="basic_scatter" data-colors='["#1f58c7", "#28b765","#f4c238"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="images_scatter" data-colors='["#974be0", "#ed5555"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="multi_treemap" data-colors='["#1f58c7","#28b765"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="multiple_radialbar" data-colors='["#1f58c7","#28b765","#f4c238","#ed5555"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="multi_radar" data-colors='["#1f58c7","#52c6ea","#28b765"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="basic_polar_area" data-colors='["#1f58c7", "#51d28c", "#f7cc53", "#f34e4e", "#974be0", "#5fd0f3"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="monochrome_polar_area" data-colors='["#1f58c7"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div><!--end card-->
                    </div><!-- end col -->
                </div><!-- end row -->
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/charts-apex.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:32 GMT -->
</html>