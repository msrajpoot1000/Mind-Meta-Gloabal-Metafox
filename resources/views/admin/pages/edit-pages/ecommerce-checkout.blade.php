...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:07 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Checkout | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">Checkout</h4>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle mb-0 table-nowrap">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><img src="{{ asset('assets/admin/images/product/img-1.png') }}" alt="product-img" title="product-img" class="avatar-md"></th>
                                                        <td>
                                                            <h5 class="font-size-15 text-truncate"><a href="ecommerce-product-detail.html" class="text-body">Home & Office Chair Crime</a></h5>
                                                            <p class="text-muted mb-0">$ 260 x 2</p>
                                                        </td>
                                                        <td>$ 520</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"><img src="{{ asset('assets/admin/images/product/img-2.png') }}" alt="product-img" title="product-img" class="avatar-md"></th>
                                                        <td>
                                                            <h5 class="font-size-15 text-truncate"><a href="ecommerce-product-detail.html" class="text-body">Sofa Home Chair Black</a></h5>
