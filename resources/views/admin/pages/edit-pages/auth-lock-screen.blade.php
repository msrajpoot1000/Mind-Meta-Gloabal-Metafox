...
<!-- Mirrored from themesdesign.in/webadmin/layouts/auth-lock-screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:28:49 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Lock Screen | webadmin - Admin & Dashboard Template</title>
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <form action="https://themesdesign.in/webadmin/layouts/index.html">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">Not you ? return <a href="auth-login.html" class="fw-medium text-primary"> Sign In </a></p>
                                        </div>
                                    </form>
                                </div>
