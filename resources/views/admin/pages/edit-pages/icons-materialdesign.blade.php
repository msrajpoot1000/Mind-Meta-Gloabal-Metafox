...
<!-- Mirrored from themesdesign.in/webadmin/layouts/icons-materialdesign.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:37 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Material Design | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">Material Design</h4>
                        </div>
                        <!-- end page title -->
