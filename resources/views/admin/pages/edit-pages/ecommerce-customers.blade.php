...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:06 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Customers | webadmin - Admin & Dashboard Template</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4 class="mb-0">9,454 <span class="fw-medium text-success font-size-18"><i class="bx bx-up-arrow-alt font-size-16 align-middle"></i> 16%</span></h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4 class="mb-0">563 <span class="fw-medium text-success font-size-18"><i class="bx bx-up-arrow-alt font-size-16 align-middle"></i> 24%</span></h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4 class="mb-0">454 <span class="fw-medium text-danger font-size-18"><i class="bx bx-down-arrow-alt font-size-16 align-middle"></i> 07%</span></h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4 class="mb-0">1,526k <span class="fw-medium text-success font-size-18"><i class="bx bx-up-arrow-alt font-size-16 align-middle"></i> 16%</span></h4>
                                    ...
                                    <div class="card-body">
                                        <div class="position-relative">
                                            <div class="modal-button mt-2">
                                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".new-customer"><i class="mdi mdi-plus me-1"></i> New Customer</button>
                                            </div>
                                        </div>
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:07 GMT -->
</html>