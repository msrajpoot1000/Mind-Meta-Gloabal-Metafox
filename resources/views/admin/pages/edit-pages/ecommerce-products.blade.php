...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:00 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Products | webadmin - Admin & Dashboard Template</title>
                                ...
                                <div class="card">
                                    ...
                                    <div>
                                        <div class="custom-accordion p-4">
                                            <h5 class="font-size-14 mb-0"><a href="#categories-collapse" class="text-body d-block" data-bs-toggle="collapse">Categories <i class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                        ...
                                        <div class="custom-accordion">
                                            <div class="p-4 border-top">
                                                <div>
                                                    <h5 class="font-size-14 mb-0"><a href="#filtersizes-collapse" class="text-body d-block" data-bs-toggle="collapse">Sizes <i class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                            ...
                                            <div class="p-4 border-top">
                                                <div>
                                                    <h5 class="font-size-14 mb-0"><a href="#filterprodductcolor-collapse" class="text-body d-block" data-bs-toggle="collapse">Colors <i class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                                    ...
                                                    <div class="collapse show" id="filterprodductcolor-collapse">
                                                        <div class="mt-4">
                                                            <div class="form-check mt-2">
                                                                ...
                                                                <label class="form-check-label" for="productcolorCheck1"><i class="mdi mdi-circle text-body mx-1"></i> Black</label>
                                                            </div>
                                                            <div class="form-check mt-2">
                                            ...
                                            <div class="p-4 border-top">
                                                <div>
                                                    <h5 class="font-size-14 mb-0"><a href="#filterproduct-color-collapse" class="text-body d-block" data-bs-toggle="collapse">Customer Rating <i class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                            ...
                                            <div class="p-4 border-top">
                                                <div>
                                                    <h5 class="font-size-14 mb-0"><a href="#filterproduct-discount-collapse" class="text-body d-block" data-bs-toggle="collapse">Discount <i class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                                           ...
                                                           <div class="row align-items-center">
                                                            <div class="col-md-6">
                                                                <div class="p-4 p-xl-0">
                                                                 <img src="{{ asset('assets/admin/images/product/img-8.png') }}" class="img-fluid" alt="">
                                                                </div>
                                                             </div>
        
                                                             <div class="col-md-6">
                                                               <div class="p-4 p-xl-0">
                                                                    <h3 class="mb-2 text-truncate"><a href="ecommerce-product-detail.html">Tuition Classes Chair Crime </a></h3>
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-xl-11 col-lg-11">
                                                           <div class="row align-items-center">
                                                            <div class="col-md-6">
                                                                <div class="p-4 p-xl-0">
                                                                 <img src="{{ asset('assets/admin/images/product/img-4.png') }}" class="img-fluid" alt="">
                                                                </div>
                                                             </div>
        
                                                             <div class="col-md-6">
                                                               <div class="p-4 p-xl-0">
                                                                    <h3 class="mb-2 text-truncate"><a href="ecommerce-product-detail.html">Home & Office Chair Crime </a></h3>
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-xl-11 col-lg-11">
                                                           <div class="row align-items-center">
                                                            <div class="col-md-6">
                                                                <div class="p-4 p-xl-0">
                                                                 <img src="{{ asset('assets/admin/images/product/img-6.png') }}" class="img-fluid" alt="">
                                                                </div>
                                                             </div>
        
                                                             <div class="col-md-6">
                                                               <div class="p-4 p-xl-0">
                                                                    <h3 class="mb-2 text-truncate"><a href="ecommerce-product-detail.html">Hotel Dining Table And Chair</a></h3>
                                                    ...
                                                    <div class="tab-pane active" id="popularity" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-1.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Home & Office Chair Crime</a></h5>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-2.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Black, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Sofa Home Chair Black</a></h5>
                                                                        <p class="text-muted mb-0">
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-3.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Tuition Classes Chair Crime</a></h5>
                                                                        <p class="text-muted mb-0">
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-4.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Dining Table And Chair</a></h5>
                                                                        <p class="text-muted mb-0">
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                                            <i class="bx bxs-star text-warning font-size-12"></i>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-5.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Home & Office Chair Crime</a></h5>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-6.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Home & Office Chair Crime</a></h5>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-7.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Tuition Classes Chair Crime</a></h5>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-8.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Dining Table And Chair</a></h5>
                                                            ...
                                                            <div class="col-xl-4 col-sm-6">
                                                                <div class="product-box rounded p-3 mt-4">
                                                                    ...
                                                                    <div class="product-img bg-light p-3 rounded">
                                                                        <img src="{{ asset('assets/admin/images/product/img-9.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                    <div class="product-content pt-3">
                                                                        <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
                                                                        <h5 class="mt-1 mb-0"><a href="#" class="text-body font-size-16">Home & Office Chair Crime</a></h5>
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:04 GMT -->
</html>