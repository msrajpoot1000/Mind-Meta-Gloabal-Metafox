...
<!-- Mirrored from themesdesign.in/webadmin/layouts/charts-chartjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:32 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Chartjs Charts | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">Chartjs Charts</h4>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="lineChart" class="chartjs-chart" data-colors='["rgba(31, 88, 199, 0.2)", "#3b76e1", "rgba(235, 239, 242, 0.2)", "#ebeff2"]'></canvas>   
                                    </div>
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="bar" class="chartjs-chart" data-colors='["rgba(40, 183, 101, 0.8)", "rgba(40, 183, 101, 0.9)"]'></canvas>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="polarArea" class="chartjs-chart" data-colors='["#52c6ea", "#28b765", "#ed5555", "#3b76e1"]'> </canvas>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="radar" class="chartjs-chart" data-colors='["rgba(42, 181, 125, 0.2)", "#28b765", "rgba(31, 88, 199, 0.2)", "#3b76e1"]'></canvas>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                        </div> <!-- end row -->
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/charts-chartjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:33 GMT -->
</html>