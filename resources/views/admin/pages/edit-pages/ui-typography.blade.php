...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ui-typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:19 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Typography | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">Typography</h4>
                        </div>
                        <!-- end page title -->
