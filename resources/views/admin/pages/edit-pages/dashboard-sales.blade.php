...
<!-- Mirrored from themesdesign.in/webadmin/layouts/dashboard-sales.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:28:50 GMT -->
<head>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mx-n4" data-simplebar style="max-height: 390px;">
                                            ...
                                            <div class="border-bottom sales-history">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="assets/images/users/avatar-2.jpg" class="rounded-circle avatar img-thumbnail" alt="">
                                                    </div>
                                                    <div class="flex-grow-1 ms-3 overflow-hidden">
                                            ...
                                            <div class="border-bottom sales-history">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="assets/images/users/avatar-3.jpg" class="rounded-circle avatar img-thumbnail" alt="">
                                                    </div>
                                                    <div class="flex-grow-1 ms-3 overflow-hidden">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="avatar">
                                                                <div class="product-img avatar-title img-thumbnail bg-primary-subtle  border-0">
                                                                    <img src="{{ asset('assets/admin/images/product/img-1.png') }}" class="img-fluid" alt="">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="avatar">
                                                                <div class="product-img avatar-title img-thumbnail bg-success-subtle  border-0">
                                                                    <img src="{{ asset('assets/admin/images/product/img-2.png') }}" class="img-fluid" alt="">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="avatar">
                                                                <div class="product-img avatar-title img-thumbnail bg-danger-subtle  border-0">
                                                                    <img src="{{ asset('assets/admin/images/product/img-3.png') }}" class="img-fluid" alt="">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar">
                                                                <div class="product-img avatar-title img-thumbnail bg-success-subtle  border-0">
                                                                    <img src="{{ asset('assets/admin/images/product/img-5.png') }}" class="img-fluid" alt="">
                                                                </div>
                                                            </div>
                                                        </td>
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/dashboard-sales.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:28:51 GMT -->
</html>