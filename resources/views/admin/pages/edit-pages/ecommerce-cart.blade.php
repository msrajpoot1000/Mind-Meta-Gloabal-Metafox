...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:07 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Cart | webadmin - Admin & Dashboard Template</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle mb-0 table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><img src="{{ asset('assets/admin/images/product/img-1.png') }}" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-body">Home & Office Chair Crime </a></h5>
                                                    ...
                                                    <tr>
                                                        <th><img src="{{ asset('assets/admin/images/product/img-2.png') }}" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-body">Sofa Home Chair Black</a></h5>
                                                    ...
                                                    <tr>
                                                        <th><img src="{{ asset('assets/admin/images/product/img-5.png') }}" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-body">Tuition Classes Chair Crime</a></h5>
                                                    ...
                                                    <tr>
                                                        <th><img src="{{ asset('assets/admin/images/product/img-7.png') }}" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-body">Dining Table And Chair</a></h5>
                                                    ...
                                                    <tr>
                                                        <th><img src="{{ asset('assets/admin/images/product/img-8.png') }}" alt="" class="avatar-lg rounded p-1"></th>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-truncate font-size-16"><a href="ecommerce-product-detail.html" class="text-body">Home & Office Chair Crime</a></h5>
