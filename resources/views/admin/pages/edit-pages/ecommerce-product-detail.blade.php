...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:04 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Product Detail | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">Product Detail</h4>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="product-detail mt-3" dir="ltr">
                                                    ...
                                                    <div class="swiper product-thumbnail-slider rounded border overflow-hidden position-relative">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide rounded">
                                                               <div class="p-3">
                                                                    <div class="product-img bg-light rounded p-3">
                                                                        <img src="{{ asset('assets/admin/images/product/img-1.png') }}" class="img-fluid d-block" />
                                                                    </div>
                                                               </div>
                                                            </div>
                                                            ...
                                                            <div class="swiper-slide rounded">
                                                                <div class="p-3">
                                                                    <div class="product-img bg-light rounded p-3">
                                                                        <img src="{{ asset('assets/admin/images/product/img-2.png') }}" class="img-fluid d-block" />
                                                                    </div>
                                                               </div>
                                                            </div>
                                                            ...
                                                            <div class="swiper-slide rounded">
                                                                <div class="p-3">
                                                                    <div class="product-img bg-light rounded p-3">
                                                                        <img src="{{ asset('assets/admin/images/product/img-3.png') }}" class="img-fluid d-block" />
                                                                    </div>
                                                               </div>
                                                            </div>
                                                            ...
                                                            <div class="swiper-slide rounded">
                                                                <div class="p-3">
                                                                    <div class="product-img bg-light rounded p-3">
                                                                        <img src="{{ asset('assets/admin/images/product/img-6.png') }}" class="img-fluid d-block" />
                                                                    </div>
                                                               </div>
                                                            </div>
                                                           ...
                                                           <div class="swiper-slide rounded">
                                                            <div class="p-3">
                                                                <div class="product-img bg-light rounded p-3">
                                                                    <img src="{{ asset('assets/admin/images/product/img-5.png') }}" class="img-fluid d-block" />
                                                                </div>
                                                           </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mt-4">
                                                        <div thumbsSlider="" class="swiper product-nav-slider mt-2 overflow-hidden">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide rounded">
                                                                    <div class="nav-slide-item"><img src="{{ asset('assets/admin/images/product/img-1.png') }}" class="img-fluid p-1 d-block rounded" /></div>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <div class="nav-slide-item"><img src="{{ asset('assets/admin/images/product/img-2.png') }}" class="img-fluid p-1 d-block rounded" /></div>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <div class="nav-slide-item"><img src="{{ asset('assets/admin/images/product/img-3.png') }}" class="img-fluid p-1 d-block rounded" /></div>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <div class="nav-slide-item"><img src="{{ asset('assets/admin/images/product/img-6.png') }}" class="img-fluid p-1 d-block rounded" /></div>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <div class="nav-slide-item"><img src="{{ asset('assets/admin/images/product/img-5.png') }}" class="img-fluid p-1 d-block rounded" /></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xl-8">
                                                <div class="mt-3 mt-xl-3 ps-xl-5">
                                                    <h4 class="font-size-20 mb-3"><a href="#" class="text-body">Home & Office Chair Crime</a></h4>
                                                                ...
                                                                <form action="#">
                                                                    <div class="px-2 py-1 bg-light">
                                                                        <div class="btn-group" role="group">
                                                                            <button type="button" class="btn btn-sm btn-link text-body text-decoration-none"><i class="bx bx-link"></i></button>
                                                                            <button type="button" class="btn btn-sm btn-link text-body text-decoration-none"><i class="bx bx-smile"></i></button>
                                                                            <button type="button" class="btn btn-sm btn-link text-body text-decoration-none"><i class="bx bx-at"></i></button>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="tab-pane fade" id="desc" role="tabpanel">
                                                            <div class="row">
                                                                <div class="col-sm-3 col-md-3">
                                                                    <div>
                                                                        <img src="{{ asset('assets/admin/images/product/img.png') }}" alt="" class="img-fluid mx-auto rounded d-block">
                                                                    </div>
                                                                </div>
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:05 GMT -->
</html>