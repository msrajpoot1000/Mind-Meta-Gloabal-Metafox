...
<!-- Mirrored from themesdesign.in/webadmin/layouts/charts-tui.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:33 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Toast UI Charts | webadmin - Admin & Dashboard Template</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">Toast UI Charts</h4>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="bubble-charts" data-colors='["#1f58c7","#28b765","#f4c238","#ed5555","#57c9eb"]' dir="ltr"></div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                            <div class="col-xl-6">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="pie-charts" data-colors='["#1f58c7","#28b765", "#52c6ea","#ed5555","#f4c238"]' dir="ltr"></div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                            <div class="col-xl-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="treemap-charts"  data-colors='["#1f58c7","#28b765","#f4c238", "#ed5555"]' dir="ltr"></div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="bullet-charts" data-colors='["#1f58c7","#28b765","#f4c238","#ed5555"]' dir="ltr"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="radial-charts" data-colors='["#1f58c7","#28b765","#f4c238","#ed5555"]' dir="ltr"></div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                        </div>  
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/charts-tui.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:35 GMT -->
</html>