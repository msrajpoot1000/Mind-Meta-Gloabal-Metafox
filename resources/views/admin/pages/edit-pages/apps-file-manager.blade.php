...
<!-- Mirrored from themesdesign.in/webadmin/layouts/apps-file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:28:59 GMT -->
<head>

        <meta charset="utf-8" />
        <title>File Manager | webadmin - Admin & Dashboard Template</title>
                                                ...
                                                <div class="mx-n4 mt-4" data-simplebar style="max-height: 350px;">
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table align-middle table-nowrap table-hover mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-file-document font-size-20 align-middle text-primary me-2"></i> index.html</a></td>
                                                                    <td>12-10-2021</td>
                                                                    <td>09 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-folder-zip font-size-20 align-middle text-warning me-2"></i> Project-A.zip</a></td>
                                                                    <td>11-10-2021</td>
                                                                    <td>115 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-image font-size-20 align-middle text-muted me-2"></i> Img-1.jpeg</a></td>
                                                                    <td>11-10-2021</td>
                                                                    <td>86 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-text-box font-size-20 align-middle text-muted me-2"></i> update list.txt</a></td>
                                                                    <td>10-10-2021</td>
                                                                    <td>08 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-folder font-size-20 align-middle text-warning me-2"></i> Project B</a></td>
                                                                    <td>10-10-2021</td>
                                                                    <td>72 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-text-box font-size-20 align-middle text-muted me-2"></i> Changes list.txt</a></td>
                                                                    <td>09-10-2021</td>
                                                                    <td>07 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-image font-size-20 align-middle text-success me-2"></i> Img-2.png</a></td>
                                                                    <td>09-10-2021</td>
                                                                    <td>31 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="mdi mdi-folder font-size-20 align-middle text-warning me-2"></i> Project C</a></td>
                                                                    <td>09-10-2021</td>
                                                                    <td>20 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
                                                                ...
                                                                <tr>
                                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-file font-size-20 align-middle text-primary me-2"></i> starter-page.html</a></td>
                                                                    <td>08-10-2021</td>
                                                                    <td>11 KB</td>
                                                                    <td>
                                                                        <div class="avatar-group">
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/apps-file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:00 GMT -->
</html>