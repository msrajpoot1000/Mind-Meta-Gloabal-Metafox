...
<!-- Mirrored from themesdesign.in/webadmin/layouts/pages-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:44 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Pricing | webadmin - Admin & Dashboard Template</title>
                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <div class="plan-features mt-4">
                                            ...
                                            <p class="font-size-15"><i class="mdi mdi-checkbox-marked-circle text-success font-size-16 me-2 align-middle"></i><b>1</b>
                                                User Account</p>
                                            <p class="font-size-15"><i class="mdi mdi-close-circle text-danger font-size-16 me-2 align-middle"></i><b>100+</b>
                                                Video Tuts</p>
                                        ...
                                        <div class="mt-4">
                                            <p class="text-muted mb-0">For small teams trying out webadmin for an unlimited period of time</p>
                                        </div>

                                        <div class="mt-4">
                                            <h2 class="text-muted"><s class="font-size-22"> $29.99</s> <span class="plan ps-1 text-primary">$19.99 </span></h2>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card plan-box overflow-hidden">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="mt-4">
                                            <h2 class="text-muted"><s class="font-size-22"> $39.99</s> <span class="plan ps-1 text-primary">$29.99 </span></h2>
                                            <p class="mb-0">Per Month</p>
                                        </div>
                                ...
                                <div class="card plan-box overflow-hidden">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="plan-features mt-4">
                                            ...
                                            <p class="font-size-15"><i class="mdi mdi-checkbox-marked-circle text-success font-size-16 me-2 align-middle"></i><b>1</b>
                                                User Account</p>
                                            <p class="font-size-15"><i class="mdi mdi-checkbox-marked-circle text-success text-danger font-size-16 me-2 align-middle"></i><b>100+</b>
                                                Video Tuts</p>
                                            <p class="font-size-15"><i class="mdi mdi-close-circle text-danger font-size-16 me-2 align-middle"></i><b>Public</b>
                                                Displays
                                            </p>
                                        ...
                                        <div class="mt-4">
                                            <h2 class="text-muted"><s class="font-size-22"> $89.99</s> <span class="plan ps-1 text-primary">$79.99 </span></h2>
                                            <p class="mb-0">Per Month</p>
                                        </div>
                                ...
                                <div class="card plan-box overflow-hidden">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="plan-features mt-4">
                                            ...
                                            <p class="font-size-15"><i class="mdi mdi-checkbox-marked-circle text-success font-size-16 me-2 align-middle"></i><b>100+</b>
                                                Video Tuts</p>
                                            <p class="font-size-15"><i class="mdi mdi-checkbox-marked-circle text-success font-size-16 me-2 align-middle"></i><b>Public</b>
                                                Displays
                                            </p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <h2 class="text-muted"><s class="font-size-22"> $119.99</s> <span class="plan ps-1 text-primary">$99.99 </span></h2>
                                            <p class="mb-0">Per Month</p>
                                        </div>
