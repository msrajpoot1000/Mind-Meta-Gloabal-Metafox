...
<!-- Mirrored from themesdesign.in/webadmin/layouts/auth-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:28:50 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Logout | webadmin - Admin & Dashboard Template</title>
                            ...
                            <div class="card-body p-4"> 
                                <div class="p-2 my-2 text-center">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <p class="text-muted font-size-15">Thank you for using <span class="fw-semibold text-body">webadmin</span></p>
                                        <div class="mt-4">
