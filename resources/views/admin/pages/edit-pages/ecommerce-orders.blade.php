...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:05 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Orders | webadmin - Admin & Dashboard Template</title>
                                    ...
                                    <div class="card-body">
                                        <div class="position-relative">
                                            <div class="modal-button mt-2">
                                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".add-new-order"><i class="mdi mdi-plus me-1"></i> Add New Order</button>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table align-middle table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <div>
                                                        <img src="{{ asset('assets/admin/images/product/img-1.png') }}" alt="" class="rounded avatar-md">
                                                    </div>
                                                </th>
                                                <td>
                                                    <div>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div>
                                                        <img src="{{ asset('assets/admin/images/product/img-2.png') }}" alt="" class="rounded avatar-md">
                                                    </div>
                                                </th>
                                                <td>
                                                    <div>
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/ecommerce-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 05:29:06 GMT -->
</html>