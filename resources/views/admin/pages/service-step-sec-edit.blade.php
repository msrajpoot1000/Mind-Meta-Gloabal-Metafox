        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin-service-step-sec.update', $item->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="step_description" id="description1"
                                class="form-control @error('step_description') is-invalid @enderror" rows="4">{{ old('step_description', $item->step_description ?? '') }}</textarea>
