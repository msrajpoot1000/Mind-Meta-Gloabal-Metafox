...
@section('title', 'Dashboard | Add ' . ucfirst('Com Reg Why Sec'))
...
@section('content')
    ...
    <div class="mb-2 d-flex justify-content-end fw-bold">
        <button id="toggleButton" class="btn btn-sm btn-success px-4 fs-5">Create {{ ucfirst('Com Reg Why Sec') }}</button>
    </div>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Add {{ ucfirst('Com Reg Why Sec') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin-com-reg-why-sec.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="row mt-4">
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All {{ ucfirst('Com Reg Why Sec') }}</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse($items as $item)
                                    <tr>
                                        ...
                                        <td class="v-center">
                                            <a href="{{ route('admin-com-reg-why-sec.edit', $item->id) }}"
                                                class="btn btn-sm btn-success px-4 m-1">Edit</a>
                                            <form action="{{ route('admin-com-reg-why-sec.destroy', $item->id) }}"
