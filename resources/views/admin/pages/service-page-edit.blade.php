        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin-service-page.update', $item2->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label>Service Page <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description1" class="form-control @error('description') is-invalid @enderror"
                                rows="4">{{ old('description', $item2->description ?? '') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="license_section_heading" id="license_section_heading"
                                ...
                                value="{{ old('license_section_heading', $item2->license_section_heading ?? '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="business_legal_heading" id="business_legal_heading"
                                ...
                                value="{{ old('business_legal_heading', $item2->business_legal_heading ?? '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="benefit_heading" id="benefit_heading"
                                ...
                                value="{{ old('benefit_heading', $item2->benefit_heading ?? '') }}">
                        ...
                        <div class="mb-3">
                            @php
                                $selectedFaqs = old('benefit_ids', json_decode($item2->benefit_ids ?? '[]', true));
                            @endphp
                            <label for="benefit_ids" class="form-label">Benefit</label>
