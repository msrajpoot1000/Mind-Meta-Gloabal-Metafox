    ...
    <div id="create-form-section">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin-sub-industries.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                @forelse ($subIndustries as $sub)
                                    <tr>
                                        ...
                                        <td class="v-center" class="d-flex flex-wrap row-gap-2">
                                            ...
                                            <a href="{{ route('admin-sub-industries.edit', $sub->id) }}"
                                                class="btn btn-sm btn-success px-4 m-1">Edit</a>

                                            <form action="{{ route('admin-sub-industries.destroy', $sub->id) }}" method="POST"
