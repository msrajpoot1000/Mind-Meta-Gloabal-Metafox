...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin-key-cor-services.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <div class="col-md-6 d-flex align-items-center justify-content-center">
        <img id="photo_preview_photo" src="{{ asset($item->photo) }}" alt="No Image" style="max-width: 5rem; border: 1px solid #ccc; padding: 5px;">
        <input type="hidden" name="status_photo" id="status_photo" value="{{ $item->photo ? 1 : 0 }}">
