...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin-promotion-page.update', $item2->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label>Promotion Page <span class="text-danger">*</span></label>
...
<div class="mb-3">
    ...
    <textarea name="description" id="description1" class="form-control @error('description') is-invalid @enderror" rows="4">{{ old('description', $item2->description ?? '') }}</textarea>
...
<div class="row">
    ...
    <div class="col-md-6 d-flex align-items-center justify-content-center">
        <img id="photo_preview_banner_image" src="{{ asset($item2->banner_image) }}" alt="No Image" style="max-width: 5rem; border: 1px solid #ccc; padding: 5px;">
<input type="hidden" name="status_banner_image" id="status_banner_image" value="{{ $item2->banner_image ? 1 : 0 }}">
...
<div class="mb-3">
    ...
    <input type="text" name="banner_heading" id="banner_heading" class="form-control @error('banner_heading') is-invalid @enderror" value="{{ old('banner_heading', $item2->banner_heading ?? '') }}">
...
<div class="mb-3">
    ...
    <textarea name="banner_description" id="description2" class="form-control @error('banner_description') is-invalid @enderror" rows="4">{{ old('banner_description', $item2->banner_description ?? '') }}</textarea>
