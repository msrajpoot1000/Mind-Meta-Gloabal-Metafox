...
@section('title', 'Dashboard | Add ' . ucfirst('Com Reg'))
...
@section('content')
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Add {{ ucfirst('Com Reg') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin-com-reg.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="row mt-4">
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All {{ ucfirst('Com Reg') }}</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse($items as $item)
                                    <tr>
                                        ...
                                        <td class="v-center">
                                            <a href="{{ route('admin-com-reg.edit', $item->id) }}"
                                                class="btn btn-sm btn-success px-4 m-1">Edit</a>
                                            <form action="{{ route('admin-com-reg.destroy', $item->id) }}" method="POST"
