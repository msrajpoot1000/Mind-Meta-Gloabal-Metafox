...
@section('content')
    ...
    <div class="mb-2 d-flex justify-content-end fw-bold">
        <button id="toggleButton" class="btn btn-sm btn-success px-4 fs-5">Create
            {{ ucfirst('Fin Service Benefit Sec') }}</button>
    </div>
    ...
    <div id="create-form-section">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin-fin-service-benefit-sec.store') }}" method="POST"
                            ...
                            <tbody>
                                @forelse($items as $item)
                                    <tr>
                                        ...
                                        <td class="v-center">
                                            <a href="{{ route('admin-fin-service-benefit-sec.edit', $item->id) }}"
                                                class="btn btn-sm btn-success px-4 m-1">Edit</a>
                                            <form action="{{ route('admin-fin-service-benefit-sec.destroy', $item->id) }}"
