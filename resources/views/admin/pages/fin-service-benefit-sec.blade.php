...
@section('title', 'Dashboard | Add ' . ucfirst("Fin Service Benefit Sec"))
...
<div class="mb-2 d-flex justify-content-end fw-bold">
    <button id="toggleButton" class="btn btn-sm btn-success px-4 fs-5">Create {{ ucfirst("Fin Service Benefit Sec") }}</button>
</div>
    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Add {{ ucfirst("Fin Service Benefit Sec") }}</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin-fin-service-benefit-sec.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<div class="row mt-4">
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">All {{ ucfirst("Fin Service Benefit Sec") }}</h4>
            </div>
            <div class="card-body">
...
<td class="v-center">
    ...
    @endif
                                    ...
                                    <td class="v-center">
                                        <a href="{{ route('admin-fin-service-benefit-sec.edit', $item->id) }}" class="btn btn-sm btn-success px-4 m-1">Edit</a>
                                        <form action="{{ route('admin-fin-service-benefit-sec.destroy', $item->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
