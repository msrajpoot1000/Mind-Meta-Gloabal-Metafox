                    ...
                    <form action="{{ route('admin-blog.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file"
                                        class="form-control preview-image-input @error('blog_image') is-invalid @enderror"
                                        name="blog_image" id="blog_image" data-preview-id="photo_preview_blog_image"
                                        accept="image/*">
                                    @error('blog_image')
                            ...
                            <div class="col-md-6 d-flex align-items-center justify-content-center">
                                <img id="photo_preview_blog_image" src="{{ asset($item->blog_image) }}" alt="No Image"
                                    style="max-width: 5rem; border: 1px solid #ccc; padding: 5px;">
                                <input type="hidden" name="status_blog_image" id="status_blog_image"
                                    value="{{ $item->blog_image ? 1 : 0 }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="blog_title" id="blog_title"
                                ...
                                value="{{ old('blog_title', $item->blog_title ?? '') }}">
                            @error('blog_title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="blog_description" id="description1"
                                class="form-control @error('blog_description') is-invalid @enderror" rows="4">{{ old('blog_description', $item->blog_description ?? '') }}</textarea>
