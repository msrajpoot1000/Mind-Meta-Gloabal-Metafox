...
@section('content')
            ...
            <div class="row align-center">
                <div class="col-lg-5 mb-md-60">
                    <div class="service-nav-info">
                        <h4 class="sub-title "> <span class="txw-767min" style="color:#2C3F7E">Mind Meta Global Will Help
                                You
                                With</span>
                        </h4>
                        <h2 class="txw-767min">All In One Business Setup Services</h2>
                        <p class="txw-767min">We offer you the all-in-one company services needed for Dubai mainland
                            ...
                            <div class=" tab-pane fade show {{ $loop->first ? 'active' : '' }}"
                                ...
                                <div class="row ">
                                    @foreach ($service->servicePages as $page)
                                        <!-- Single Item -->
                                        {{-- wow fadeInUp --}}
                                        <div class="setup-button col-lg-6 col-md-6 mt-60 mt-md-30 mt-xs-30 pb-2 d-flex">
                                            <div class="shadow-sm flex-column"
                                                style="background-color:white;border-radius:10px;padding:2rem;margin-right:0rem">
                                                <div onclick="window.location.href='{{ route('user.pages.servicePage', $page->id) }}'"
                                                    class="serviceJi services-style-one" style="cursor: pointer;">
    ...
    <div class="project-details-area default-padding"
        style="background-image: url('{{ asset('assets/img/shape/our_affi1.jpg') }}');background-repeat:no-repeat;background-size:100% 100%;">
        <div class="container">
            <div class="row align-center">
                <div class="about-style-one col-xl-12 col-lg-11">
                    <!--<div class="h4 sub-heading">Feel Valued & Rewarded</div>-->
                    <h2 class="title mb-25" style="color:white">Our Affiliations With Government Bodies​</h2>
                    <p style="color:white">
        ...
        <div class="container">
            <div class="row align-center">
                <div class="col-lg-12">
                    ...
                    <a class="btn circle btn-light mt-30 mt-md-15 mt-xs-10 btn-md radius animation">Innovate</a>
                    <a class="btn circle btn-light mt-30 mt-md-15 mt-xs-10 btn-md radius animation">Learn</a>
                    <a class="btn circle btn-light mt-30 mt-md-15 mt-xs-10 btn-md radius animation">Grow</a>
                </div>
