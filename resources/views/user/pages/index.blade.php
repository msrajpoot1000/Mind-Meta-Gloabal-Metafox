...
background-color: #0b57e3 !important;
   ...
   <!-- Start Banner Area 
    ...
    <div class="banner-area banner-style-one shadow navigation-custom-large zoom-effect overflow-hidden text-light">
        ...
        <div class="banner-fade">
            ...
            <div class="swiper-wrapper">
                        ...
                        <div class="row align-center">
                            <div class="col-xl-7 offset-xl-5">
                                <div class="content">
                                    ...
                                    <strong>Business Setup in Dubai</strong></h3>
                                    <h4><strong>From Beginning to Your Personalized Needs</strong></h4>
                                    <p>Your personalized advisor, who answers all your new business setup queries, helps you grow your business hassle-free by providing all-in-one company setup solutions under one roof.</p>
                                    <p><strong>Idea Concept | Business Plan | Company Registration | Corporate Bank Account</strong></p>
                ...
                <!-- Single Item -->
                <div class="swiper-slide banner-style-one">
                    <div class="banner-thumb bg-cover shadow dark" style="background: url(assets/img/banner/home2.png);"></div>
                    <div class="container">
                        <div class="row align-center">
                            <div class="col-xl-7 offset-xl-5">
                                <div class="content">
            ...
            <div class="row align-center">
                ...
                <div class="col-lg-6 offset-lg-1 pl-60 pl-md-15 pl-xs-10 mt-md-50 mt-xs-50">
                    ...
                    <div class="f-item company">
                            <form action="#">
                                <input type="text" placeholder="Type your desired company name here" class="form-control" name="your_company">
    ...
    <!-- Start Aobut 
    ============================================= -->
    <div class="about-style-two-area overflow-hidden bg-contain bg-gray default-padding" style="background-image: url(assets/img/shape/29.png);">
        <div class="container">
            <div class="row align-center">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <p>Meta Mind Global, your partner for business setup in Dubai, the UAE, not only makes the process hassle-free, straightforward, and budget-friendly but also ensures that you are choosing the right legal structure and jurisdiction for your company objective to run your business in the long run. Find here 5 steps for setting up a business in Dubai and the UAE</p>
                    ...
                    <div class="default-features mt-30">
                        <div class="default-feature-item">
                            <a href="#">
                                ...
                                <p>Choosing the right jurisdiction for registering a company is the most important step of the whole business setup process. There are 3 main jurisdictions: Mainland, Free zone and Offshore. Let Meta Mind Global help you choose the right authority for your business setup in Dubai based on your business’s requirements.</p>
                            </a>
                        </div>
    ...
    <div class="pricing-style-one-area secondary default-padding bottom-less">
        ...
        <div class="container">
            <div class="row">
                ...
                <p>The cost of business setup in Dubai starts from AED 12,000*, but it is flexible and depends on multiple factors. Some of the major reasons for a significant difference in costs include the jurisdiction selected for company registration, type of business activity, shareholders involved, visas, and office space.</p>
                        <p>Both Mainland and Free Zone have their own requirements and fee structures that affect the overall expenses in the beginning stage. Furthermore, complex business activities requiring a specialized license or permit will also increase the costs. The total number of shareholders can also affect the overall expenditure due to associated administrative fees and capital requirements during incorporation. New office space and employee visas will add more expenses to the list.</p>
                        <p>
                            Basically, the cost of business setup in Dubai can be quite different for different investors based on these factors. Therefore, investors must research adequately and budget accordingly before starting the incorporation process
                        </p>
            </div>
        </div>
            ...
            <div class="row align-center">
                <div class="col-lg-5 mb-md-60">
                    <div class="service-nav-info">
                        ...
                        <p>We offer you the all-in-one company services needed for Dubai mainland company formation and free zones in one place. With everything you need to get your company up and running, you won’t have to deal with multiple business setup companies.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 mt-60 mt-md-30 mt-xs-30">
                                    <div class="services-style-one">
                                        ...
                                        <p>
                                            Meta Mind Global offers turnkey internal audit services in Dubai for different companies that aim to improve corporate operations and provide the best consultancy services.
                                        </p>
                                    </div>
                                </div>
                                <!-- End Single Item -->
                                ...
                                <div class="col-lg-6 col-md-6 mt-60 mt-md-30 mt-xs-30">
                                    <div class="services-style-one">
                                        ...
                                        <p>
                                           Meta Mind Global offers turnkey external audit services in Dubai for different companies that aim to improve corporate operations and provide the best consultancy services.
                                        </p>
                                    </div>
                                </div>
                                <!-- End Single Item -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 mt-60 mt-md-30 mt-xs-30">
                                    <div class="services-style-one">
                                        ...
                                        <p>
                                            Choose from our innovative range of private offices if you work with a team. Rent from us today and enjoy all the benefits and amenities of having your own office space in Dubai with Meta Mind Global as per your needs.
                                        </p>
                                    </div>
                                </div>
                                <!-- End Single Item -->
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-light text-center">
                        ...
                        <p>Don't just take our word for it. Hear from entrepreneurs who have successfully established their businesses in Dubai. Learn from their experiences and gain insights into the possibilities that await you.</p>
                        <div class="devider"></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-style-two">
                                ...
                                <div class="provider">
                                    ...
                                    <div class="thumb">
                                        <img src="assets/img/logo/05.png" alt="Logo">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row align-center">
                <div class="col-lg-12">
                    ...
                    <a class="btn circle btn-light mt-30 mt-md-15 mt-xs-10 btn-md radius animation" target="_blank" href="#">Innovate</a>
                     <a class="btn circle btn-light mt-30 mt-md-15 mt-xs-10 btn-md radius animation" target="_blank" href="#">Learn</a>
                      <a class="btn circle btn-light mt-30 mt-md-15 mt-xs-10 btn-md radius animation" target="_blank" href="#">Grow</a>
                </div>
                <p class="mt-4">With company setup in Dubai, run your business freely. Repatriate your profits and tap into both local and global markets.</p>
                    ...
                    <div class="col-xl-4 col-md-6 single-item">
                        <div class="blog-style-one">
                            ...
                            <div class="info">
                                ...
                                <h4>
                                    <a href="blog-single-with-sidebar.html">Setting up a business in Dubai, UAE – Your Complete Step by Step Guide 2025</a>
                                </h4>
                                <a href="#" class="btn-simple"><i class="fas fa-angle-right"></i> Read more</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6 single-item">
                        <div class="blog-style-one">
                            ...
                            <div class="info">
                                ...
                                <h3>
                                    <a href="blog-single-with-sidebar.html">Set Up a Company in Dubai as a UK Citizen – How to Guide 2025</a>
                                </h3>
                                <a href="#" class="btn-simple"><i class="fas fa-angle-right"></i> Read more</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 faq-style-one dark pl-50 pl-md-15 pl-xs-15">
                    ...
                    <div class="accordion" id="faqAccordion">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>
                                       ...
                                       <ul>
                                          <li>First, choose an industry and the business activity you will engage in.</li>
                                            <li>Next, you must identify the legal structure of your business. Take help from a consultant or lawyer in this step.</li>
                                               <li>Choose a location, such as the Mainland or a Free Zone, whatever suits your business.</li>
                                                              <li>Apply for a legal trade name.</li>
                                                     <li>Finalise the paperwork.</li>
                                           <li>Apply for a licence and get initial approvals.</li>
                                              <li>Register your business and open a bank account.</li>
                                                    </ul>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Starting a company in Dubai offers many benefits that are not accessible in other countries. A few major reasons to set up a business in Dubai are:

Global trading hub allowing you to start an international trading business instantly</p>
                                    <p>
                                       <ul>
    <li>Global trading hub allowing you to start an international trading business instantly</li>
    <li>Easy to start a business</li>
    <li>100% ownership for foreigners</li>
    <li>Low corporate tax and zero individual income tax</li>
    <li>Full profit repatriation is allowed</li>
    <li>Strategic location for business with advanced infrastructure</li>
    <li>Business-friendly laws with a government that supports entrepreneurship</li>
</ul>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Yes, the visa issued in Dubai is valid throughout the UAE and allows you to travel to other emirates freely. 
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="">
                        ...
                        <p>
                            Our knowledgeable consultants offer forward-looking advice to help you overcome challenging business decisions and promise the expansion and success of your business.
                        </p>
                    </div>
                </div>
                <!-- End Single Item -->
                ...
                <div class="col-lg-4">
                    <div class="">
                        ...
                        <p>
                            Our financial professionals provide specialized solutions that maximize your financial well-being. We’ll support you to reach your financial goals with everything, from budgeting to investing strategies.
                        </p>
                    </div>
                </div>
                <!-- End Single Item -->
                ...
                <div class="col-lg-4">
                    <div class="">
                        ...
                        <p>
                           Get the best modern workspaces with our expert guidance. We help you select and get an ideal coworking space with state-of-the-art facilities, easing lease contracts.
                        </p>
                    </div>
                </div>
                <!-- End Single Item -->
        ...
        <div class="container">
            <div class="row align-center">
                <div class="col-lg-6">
                    ...
                    <a class="btn circle btn-light mt-30 mt-md-15 mt-xs-10 btn-md radius animation" target="_blank" href="https://tax.gov.ae/Datafolder/Files/Guides/CT/CT%20General%20Guide%20-%20EN%20-%2010%2009%202023.pdf">See Tax Guide</a>
                </div>
