...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="file" class="form-control preview-image-input $inputClass" data-preview-id="$previewId" name="$name" id="$inputId" accept="image/*">
            $errorBlock
        </div>
    </div>
    <div class="col-md-6 d-flex align-items-center justify-content-center">
        <img id="$previewId" src="#" alt="Selected Image" style="max-width: 5rem; display: none; border: 1px solid #ccc; padding: 5px;">
    </div>
</div>
HTML;
        }
