...
BLADE;
    ...
    private function renderField(array $field): string
    {
        ...
        $asterisk = $isRequired ? '<span class="astrick">*</span>' : '';
...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            <label for="$inputId" class="form-label">$label $asterisk</label>
...
HTML;
        ...
        if ($field['type'] === 'input') {
            return <<<HTML
<div class="mb-3">
    <label for="$name" class="form-label">$label $asterisk</label>
...
HTML;
        ...
        if ($field['type'] === 'textarea') {
            ...
            return <<<HTML
<div class="mb-3">
    <label for="$textareaId" class="form-label">$label $asterisk</label>
