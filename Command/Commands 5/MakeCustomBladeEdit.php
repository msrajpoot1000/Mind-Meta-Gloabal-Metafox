...
class MakeCustomBladeEdit extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($fields as $field) {
         ...
         if ($parts[0] === 'input' && (count($parts) === 3 || count($parts) === 4)) {
    $parsedFields[] = [
        'type' => 'input',
        'inputType' => $parts[1],
        'name' => $parts[2],
...
} elseif ($parts[0] === 'textarea' && (count($parts) === 2 || count($parts) === 3)) {
    $parsedFields[] = [
        'type' => 'textarea',
        'inputType' => null,
        'name' => $parts[1],
...
} elseif ($parts[0] === 'select' && (count($parts) === 2 || count($parts) === 3)) {
    $parsedFields[] = [
        'type' => 'select',
        'inputType' => null,
        'name' => $parts[1],
...
<div class="row">
    ...
    <div class="col-md-6 d-flex align-items-center justify-content-center">
        <img id="$previewId" src="{{ asset(\$item->$name) }}" alt="Selected Image" style="max-width: 5rem; border: 1px solid #ccc; padding: 5px;">
    </div>
</div>
HTML;
        }
