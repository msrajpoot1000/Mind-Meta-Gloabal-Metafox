...
class MakeSubCatBlade extends Command
{
    ...
    // Handle fallback format like: photo:image:required or banner:file:required
    elseif (count($parts) >= 2) {
        $inputType = $parts[1];
        if ($inputType === 'image') {
            $inputType = 'file'; // normalize to HTML input type
        }
